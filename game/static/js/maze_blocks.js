...
Blockly.Blocks['maze_turn'] = {
  ...
  init: function() {
    ...
    this.setTooltip('Tourne d\'un quart de tour');
  }
};
  ...
  init: function() {
    var DIRECTIONS =
        [['si chemin devant', 'isPathForward'],
         ['si chemin à gauche', 'isPathLeft'],
         ['si chemin à droite', 'isPathRight']];
    // Append arrows to direction messages.
    ...
    this.appendStatementInput('DO')
        .appendField('faire');
    this.setTooltip("s'il y a un chemin dans la direction spécifiée, alors effectuer ces actions");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
...
Blockly.Blocks['maze_ifElse'] = {
  ...
  init: function() {
    ...
    this.appendStatementInput('ELSE')
        .appendField('sinon');
    this.setTooltip("s'il y a un chemin dans la direction spécifiée,\
...
Blockly.Blocks['maze_forever'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Répète jusqu'à")
        .appendField(new Blockly.FieldImage(super_coin, 15, 20));
    this.appendStatementInput('DO')
        .appendField("faire");
    this.setPreviousStatement(true);
    this.setTooltip("répète les blocs qui sont à l'intérieur jusqu'à arriver au but");
  }
};
